...
include("../langs/en.php");  // Language file
...
<?php
	 ...
	 //Create base directory if allowed
	if ($editor_fm_mkdir == 'true'){
		if (!is_dir($MY_DOCUMENT_ROOT))
		{
			if (!(@mkdir($MY_DOCUMENT_ROOT,0755))) echo "<script>alert('"._filemanager_mkdirfailed."');</script>";
		}
	}
	 draw_no_dir();
}
