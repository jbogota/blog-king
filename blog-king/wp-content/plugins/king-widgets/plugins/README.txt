...
plugins there unless another location is specified.  The RSS icon (rss.png)
should be placed in wp-includes/images. The scriptaculous files should go in
...
It will also work if you place the php script files in the plugins directory or
any subdirectory thereof. It will also work if you place the scriptaculous
directory in the same directory as widgets.php. It will also work if you store
the RSS icon alongside widgets.php. It's pretty flexible.
