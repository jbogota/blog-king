...
//$event_options = get_option('king_events');
//$list_webcals = explode("\n",$event_options['ical_feeds']);
//print_r($event_options);
$list_webcals[] = 'http://www.junge-union-koeln.de/wp-ical.php';						// Fill in between the quotes exact URL of a calendar that you wish
...
$language 				= 'German';		// Language support - 'English', 'Polish', 'German', 'French', 'Dutch', 'Danish', 'Italian', 'Japanese', 'Norwegian', 'Spanish', 'Swedish', 'Portuguese', 'Catalan', 'Traditional_Chinese', 'Esperanto', 'Korean'
...
$tmp_dir				= '/www/htdocs/w00605da/wp-content/plugins/king-frontend/plugins/king-events/phpicalendar/tmp/';			// The temporary directory on your system (/tmp is fine for UNIXes including Mac OS X). Any php-writable folder works.
$webcal_hours			= '3';				// Number of hours to cache webcals. Setting to '0' will always re-parse webcals.
...
//$list_webcals[] = 'http://www.junge-union-koeln.de/wp-ical.php';						// Fill in between the quotes exact URL of a calendar that you wish
//$list_webcals[] = 'http://www.erftstadt-onlinemagazin.de/erftstadt-events.ics';						// Fill in between the quotes exact URL of a calendar that you wish
//$list_webcals[] = 'http://www.google.com/calendar/ical/d997sils4nr9p8f4d3hvp0d38s@group.calendar.google.com/public/basic.ics';						// to show up in your calendar list. You must prefix the URL with http://
