...
function word_cloud($mincount=25, $minlength=3, $smallest=50, $largest=200, $unit="%", $cold="", $hot="", $before='', $after='')
{
	...
	$overusedwords = array( '', 'a', 'am', 'an', 'the', 'and', 'of', 'i', 'to', 'is', 'in', 'for', 'as', 'that', 'on', 'at', 'this', 'my', 'was', 'our', 'it', 'its', 'you', 'we', '1', '2', '3', '4', '5', '6', '7', '8', '9', '0', '10', 'about',  'actually', 'after', 'again', 'all', 'almost', 'along', 'also', 'always', 'another', 'any', 'anyone', 'anything', 'anyway', 'are', 'area', 'around',
	    'available', 'back', 'be', 'because', 'been', 'before', 'being', 'best', 'better', 'between', 'big', 'bit', 'both', 'but', 'by', 'c', 'came', 'can', 'capable', 'control', 'could', 'course', 'd', 'day', 'decided', 'did', 'didn', 'different', 'div', 'do', 'does', 'doesn', 'doing', 'down', 'drive', 'e', 'each', 'easy', 'else', 'end', 'enough', 'even', 'ever', 'every', 'example', 'few', 'find',
	     'first', 'found', 'from', 'get', 'go', 'going', 'good', 'got', 'had', 'hard', 'has', 'have', 'haven', 'he', 'her', 'hers', 'here', 'him', 'his', 'how', 'if',  'into', 'isn', 'just', 'kind', 'know', 'last', 'least', 'left', 'like', 'little', 'll', 'long', 'look', 'lot', 'm', 'made', 'make', 'many', 'may', 'maybe', 'me', 'might', 'more', 'most', 'much', 'my', 'name', 'nbsp', 'need', 'never', 'new', 'no', 'not', 'now', 'number', 'o', 'off', 'ok', 'okay', 'old', 'one', 'only', 'or', 'other', 'out', 'over', 'own', 'part', 'people', 'place', 'point', 'pretty', 'probably', 'problem', 'put', 'quite', 'quot', 'r', 're', 'really', 'results', 'right', 's', 'same', 'saw', 'say', 'see', 'set', 'several', 'she', 'should', 'since', 'size', 'small', 'so', 'some', 'someone', 'something', 'special', 'still', 'stuff', 'such', 'sure', 'system', 't', 'take', 'than', 'their', 'them', 'then', 'there', 'these', 'they', 'thing', 'things', 'think', 'those', 'though', 'through', 'time', 'today', 'together', 'too', 'took', 'two', 'up', 'us', 'use', 'used', 'using', 've', 'very', 'want', 'way', 'well', 'went', 'were', 'what', 'when', 'where', 'which', 'while', 'who', 'why', 'will', 'with', 'without', 'would', 'wouldn', 'x', 'y',  'add', 'added', 'com', 'contains', 'http', 'your',
		'immer', 'kategorien', 'zwei', 'seite', 'seiten', 'heute', 'pdf', 'zeit', 'default', 'neue', 'check', 'auch', 'nicht','und','werden','durch','jetzt','seine','kleine','zeigt','der','die','das','alle','mit','uuml','auml','ouml','von','oder','mal','unter','szlig','des','ist','muss','vor','auf','den','kann','man','ganz','viele','ich','wenn','wer','wie','wieder','wird','zur','zum','aber','als','aus','amp','bei','ber','damit','dann','dazu','dem','diese','dieser','dieses',
		'doch','einem','ein','eine','einen','einer','etwas','fuer','habe','haben','unterst','verf','ndash','hatte','ldquo',	'gibt','hat','hier','hierf','keine','nach','nnen','noch','nur','schon','sein','bitte','gute','kein','mdash','article','jeder','machen','post','pers','neu',
		'soll', 'wir','ihr','sich','mehr','sich','sie','sind', '_request', 'acute', 'artikel', 'box', 'class', 'code', 'file', 'filename', 'files', 'finden', 'findet', 'focus', 'fragen', 'informationen', 'inhalte', 'level', 'line', 'link', 'links', 'page', 'product', 'slot', 'text', 'top', 'upload_file', 'url', 'users', 'version', 'www', 'recht', 'bis', 'diesem', 'einfach', 'features', 'funktionen', 'georg', 'image', 'kunden', 'lassen', 'leciejewski', 'mir', 'neuen', 'nun', 'ohne', 'site', 'sollte', 'wurde','alles', 'bietet', 'bundle', 'colum', 'column', 'columns', 'dass', 'dies', 'einige', 'folgenden', 'geben', 'gefunden', 'gemacht', 'gen', 'ihrer', 'jedoch  neues', 'rund', 'sch', 'search', 'sehen', 'sehr', 'seiner', 'seit', 'ver', 'via', 'vom', 'wohl', 'wurden','andere','bin','bisher','del','eigene','icio','jede','jedoch','llt','org','per','sowie','weiter','weitere',
		'weiteren','zwar','anderen','dabei','sollten','neues','nutzen','eigentlich','array_keys','don','gut','in',
		'_array','geht','glich','laut','meine','mich','net','schreiben','reg','steht','raquo','ren','seinem','nat','ssen','werde','wirklich','wollen','zumindest','zwischen','ben','bereits','diesen','direkt','eigenen','eines','erste','ersten','ffentlicht','ganze','genutzt','gerade','give','gro','hlen','ihre','ihren','insert','kleinen','kommen','kommt','lange','leider','letzten','macht','menge','oben','oft','paar','please','sicher','schnell','rlich','rsquo','sieht','ten','uft','war','welche','allem','allen','aller','allerdings','already','alt','alten','anzeigen','aufl','ausf','bald','basiert','bdquo','beiden','beim','bekommt','bereit','berpr','besch','besonders','bevor','bleiben','bieten','bleibt','bringt','bzw','chsten','che','chte','comming','daf','daher','dank','dar','daran','darauf','angezeigt','anderem','ans','anschauen','bringen','dargestellt','dein','deine','deiner','denen','denn','deren','deshalb','deutlich','dir','dort','eher','einf','einigen','erh','erkl','erm','erscheint','erst','erweiterte','etc','etwa','euch','falls'
	);
