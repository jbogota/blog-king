...
if (file_exists(ABSPATH . 'wp-content/plugins/king-frontend/plugins/UltimateTagWarrior/ultimate-tag-warrior-core.php')
	&& in_array('UltimateTagWarrior/ultimate-tag-warrior.php', get_option('active_plugins'))) {
	@require_once(ABSPATH . 'wp-content/plugins/king-frontend/plugins/UltimateTagWarrior/ultimate-tag-warrior-core.php');
	$utw_is_present=true;
}
...
function af_ela_admin_pages() {
	if (function_exists('add_options_page')) add_options_page('Ext. Live Archive Options', 'Ext. Live Archive', 9, get_settings('siteurl') . '/wp-content/plugins/king-frontend/plugins/af-extended-live-archive/af-extended-live-archive-options.php');
}
